...
public class GoodsServiceImp implements GoodsService{
    ...
    public GoodsValue addGoods(GoodsValue goodsValue){
        return toValue(goodsRepo.save(toEntity(goodsValue)));
    }
    ...
    Goods toEntity(GoodsValue goodsValue) {
        ...
        goods.setItem(goodsValue.getItem());
    ...
    GoodsValue toValue(Goods goods) {
        ...
        goodsValue.setItem(goods.getItem());
